...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","Computer Science", "Mechanical Engineering","Physics",  "Chemistry", "Civil Engineering","BioTechnology Engineering", "Mathametics and Scientific Computing", "Electrical Engineering", "Aerospace Engineering", "Aeronautical Engineering", "Economics", "Printing and Packaging", "Metallurgical Engineering", "Engineering Physics", "Chemical Engineering", "Mining Engineering","Ceramic Engineering","Textile Technology", "Production and Industrial Engineering", "Others Engineering Branches"};
        ...
        uploadTask.addOnCompleteListener(AddTeachers.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(AddTeachers.this, "Went Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
