    ...
    private void updateData(String s) {
        ...
        reference.child(category).child(uniqueKey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(UpdateTeacherActivity.this, "Something whent wrong", Toast.LENGTH_SHORT).show();
            }
        });
...
//                    pd.dismiss();
                    Toast.makeText(UpdateTeacherActivity.this, "Went Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
